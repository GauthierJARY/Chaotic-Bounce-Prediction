function [ Gamma, vphi ] = billes_chaotiques_2023(name, f)
...
G = -g/2*1e3; % Accélération de la pesanteur en terme d'amplitude de mouvement
...
Gamma = (f.m(1)*0.001*omega^2)/9.81 ;
hold off ;
%     % Affichage des fits
